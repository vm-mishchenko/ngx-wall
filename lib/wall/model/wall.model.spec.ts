...
import { DividerBrickModule } from '../../divider-brick/divider-brick.module';
import { HeaderBrickModule } from '../../header-brick/header-brick.module';
import { ImgBrickModule } from '../../img-brick/img-brick.module';
import { QuoteBrickModule } from '../../quote-brick/quote-brick.module';
import { TextBrickModule } from '../../text-brick/text-brick.module';
import { VideoBrickModule } from '../../video-brick/video-brick.module';
...
describe('Wall Model', function () {
    ...
    let wallModelFactory: WallModelFactory;
    ...
    beforeEach(
        inject([WallModelFactory], (_wallModelFactory: WallModelFactory) => {
            wallModelFactory = _wallModelFactory;
        })
    );
});